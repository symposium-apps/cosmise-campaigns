...
class ReportStore {
  ...
  createReport({ title, question }) {
    ...
    const report = { id, title: safeText(title || question || 'Campaign analysis', 160), question: safeText(question, 1000), status: 'queued', revision: 1, created_at: now(), updated_at: now(), validation: null, workflow: createAgentWorkflow(), share_hash: null, share_expires_at: null };
