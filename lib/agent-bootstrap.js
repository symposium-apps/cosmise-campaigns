...
const AGENT_BOOTSTRAP = Object.freeze({
  ...
  chat_output_contract: {
    ...
    required_final_reply: 'Your report is ready in Cosmise Campaigns.',
  ...
  required_start: [
    ...
    'Call campaign_reports_start through symposium_context.call_app_tool after the question is sufficiently bounded and before any campaign read or drafted answer. Retain the new report.id.'
  ],
  ...
  completion: [
    ...
    'Do not repeat any report content in chat. Reply only: Your report is ready in Cosmise Campaigns.',
...
const AGENT_INSTRUCTIONS = [
  ...
  'Call symposium_context.get_app_agent_context with app_id=cosmise-campaigns, then call every local operation through symposium_context.call_app_tool. Never guess the managed port.',
  ...
  'Start one report before any campaign read or drafted answer, retain its report.id, then use only the bounded reads needed for the question.',
  ...
  'After ready-and-selected verification, the entire final chat reply must be exactly: Your report is ready in Cosmise Campaigns.',
